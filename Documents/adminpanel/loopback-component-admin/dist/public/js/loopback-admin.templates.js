...
// OKOK
  $templateCache.put('templates/routing/error.tpl.html',
    "<cms-toolbar title=\"'ACCESS DENIED: You are not an admin!'\" style=\"background-color:FireBrick;\"></cms-toolbar>\n" +
    ...
    "\n" +
    "                <h1 style=\"color:DodgerBlue;\">{{:: 'homeTagline' | text }}</h1>\r" +
    "\n" +
    ...
    "\r" +
    "\n" +
  //  "    <span style=\"position: relative; font-weight: 500; top: 0; right: 0; margin: 0px 0px; color: white;\">{{ landing.background.title }}</span>\r" +
    "\n" +
    "</div>"
  );
  ...
  $templateCache.put('templates/routing/landing-page.tpl.html',
    ...
    "            <md-content layout=\"column\" class=\"md-padding\">\r" +
    "\n" +
    "                <h1 style=\"color:MidnightBlue;\">{{:: 'homeTagline' | text }}</h1>\r" +
    "\n" +
    "                <md-button ui-sref=\"login\" class=\"md-primary md-raised\">{{:: 'homeButtonText' | text }}</md-button>\r" +
    "\n" +
    "            </md-content>\r" +
