...
angular.module('loopback-admin').filter('text', ["typedText", "$log", function(typedText, $log) {
  ...
  loginWithFacebook: 'delete me',
  loginWithTwitter: 'please1!11!!!',
  loginWithGoogle: 'begging u',
    ...
    views: {
      '': {
        ...
        controller: ["$scope", function($scope) {
          return $scope.pageTitle = 'Admin Panel Login';
        }]
      },
      'content@login': {
...
angular.module('loopback-admin').controller('logoutController', ["$location", "$rootScope", "Customer", function($location, $rootScope, Customer) {
  Customer.logout();
